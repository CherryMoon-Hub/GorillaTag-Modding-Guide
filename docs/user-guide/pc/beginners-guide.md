...
Download Monke Mod Manager from [**Graze's GitHub**](https://github.com/The-Graze/MonkeModManager). Click **Releases** and download the .exe file named `MonkeModManager.exe`.

> Note: If Windows alerts you that the file is unsafe/at risk, choose to keep/run anyway. This is a false-positive.

<img src="/../docs/files/preview.png" alt="Preview">
...
> Check out the [**Custom Maps Guide**](../Custom%20Maps/maploading) for info on custom maps, installation, and where to new new maps.
